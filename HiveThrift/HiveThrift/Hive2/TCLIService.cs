...
namespace Hive2
{
  public partial class TCLIService {
    ...
    public class Processor : TProcessor {
      ...
      public void GetDelegationToken_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        GetDelegationToken_args args = new GetDelegationToken_args();
        args.Read(iprot);
        iprot.ReadMessageEnd();
        GetDelegationToken_result result = new GetDelegationToken_result();
        result.Success = iface_.GetDelegationToken(args.Req);
      ...
      public void CancelDelegationToken_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        CancelDelegationToken_args args = new CancelDelegationToken_args();
        args.Read(iprot);
        iprot.ReadMessageEnd();
        CancelDelegationToken_result result = new CancelDelegationToken_result();
        result.Success = iface_.CancelDelegationToken(args.Req);
      ...
      public void RenewDelegationToken_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        RenewDelegationToken_args args = new RenewDelegationToken_args();
        args.Read(iprot);
        iprot.ReadMessageEnd();
        RenewDelegationToken_result result = new RenewDelegationToken_result();
        result.Success = iface_.RenewDelegationToken(args.Req);
    ...
    public partial class GetDelegationToken_args : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("GetDelegationToken_args");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
        if (Req != null && __isset.req) {
          field.Name = "req";
    ...
    public partial class GetDelegationToken_result : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("GetDelegationToken_result");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
    ...
    public partial class CancelDelegationToken_args : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("CancelDelegationToken_args");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
        if (Req != null && __isset.req) {
          field.Name = "req";
    ...
    public partial class CancelDelegationToken_result : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("CancelDelegationToken_result");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
    ...
    public partial class RenewDelegationToken_args : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("RenewDelegationToken_args");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
        if (Req != null && __isset.req) {
          field.Name = "req";
    ...
    public partial class RenewDelegationToken_result : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        TStruct struc = new TStruct("RenewDelegationToken_result");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
